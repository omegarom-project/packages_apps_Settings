...
public class OmegaVersionPreferenceController extends AbstractPreferenceController implements
    ...
    public OmegaVersionPreferenceController(Context context, Lifecycle lifecycle) {
        super(context);
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (pref != null) {
            pref.setSummary(Build.OMEGA_DISPLAY_VERSION);
        }
    }

    @Override
    public String getPreferenceKey() {
        return KEY_OMEGA_VERSION;
    }
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (!TextUtils.equals(preference.getKey(), KEY_OMEGA_VERSION)) {
            return false;
        }
